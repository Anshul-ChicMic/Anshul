...
//         <Image source={require('/Users/rohit3345ksChicmic/ExpenseTrackerdemo/src/images/Rectangle9.jpg')} style={{ borderRadius:50, top:65,height:42,width:42}} />
//       <DropDownPicker
//         open={openMonth}
//         value={selectedMonth}
//         items={months}
...
//         <Text>Transactions will be displayed here based on the selected tab.</Text>
//       </ScrollView>
//       </View>
//     </View>
//   );
